...
function HomePage() {
  ...
  return (
    <>
      {user && user.role === 'admin' && <OrganizationForm onOrganizationCreated={() => authTokens && fetchOrganizations()} />}
                ...
                <li key={org.id} className="bg-gray-700 p-4 rounded-md flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      <p className="font-bold text-lg">{org.latest_scan_score ? `${org.latest_scan_score}%` : 'N/A'}</p>
